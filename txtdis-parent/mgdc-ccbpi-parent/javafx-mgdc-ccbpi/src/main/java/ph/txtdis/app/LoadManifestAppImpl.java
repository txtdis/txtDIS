...
import ph.txtdis.fx.table.LoadManifestTable;
import ph.txtdis.service.LoadManifestService;

@Scope("prototype")
@Component("loadManifestApp")
public class LoadManifestAppImpl //
		extends AbstractBillableApp<LoadManifestService, LoadManifestTable, Long> //
	...
	protected void topGridLine() {
		dateGridNodes();
		referenceGridNodes(service.getLoadManifestPrompt(), 5);
		routeGridNodes();
	}
	...
	public void refresh() {
		...
		referenceIdInput.setValue(service.getLoadManifestId());
