...
public abstract class AbstractSpunSavedBillableService //
	...
	@Autowired
	protected BillableDetailedItemService itemService;
	...
	public Billable toModel(BillableEntity e) {
		...
		b.setAdjustmentValue(e.getAdjustmentValue());
		b.setIsRma(e.getRma());
	...
	protected BillableEntity create(Billable b) {
		...
		e.setAdjustmentValue(b.getAdjustmentValue());
	...
	protected BillableEntity updateTotals(BillableEntity e, Billable b) {
		e.setGrossValue(nullIfZero(b.getGrossValue()));
		e.setTotalValue(nullIfZero(b.getTotalValue()));
		e.setUnpaidValue(nullIfZero(b.getUnpaidValue()));
		return e;
	}
