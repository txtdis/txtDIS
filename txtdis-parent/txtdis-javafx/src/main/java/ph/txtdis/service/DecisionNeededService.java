...
public interface DecisionNeededService //
		extends GetterAndSetterService<Long>, Remarked {

	default <T extends DecisionNeededValidatedCreatedKeyed<Long>> String addDecisionToRemarks(T t, Boolean isValid, String remarks) {
	...
	default <T extends DecisionNeededValidatedCreatedKeyed<Long>> List<T> approve(List<T> list, Boolean isValid, String remarks) {
		return list.stream() //
	...
	default <T extends DecisionNeededValidatedCreatedKeyed<Long>> T setDecisionStatus(T t, Boolean isValid, String remarks) {
	...
	default <T extends DecisionNeededValidatedCreatedKeyed<Long>> T updateDecisionStatus(T t, Boolean isValid, String remarks) {
		if (isValid != null)
