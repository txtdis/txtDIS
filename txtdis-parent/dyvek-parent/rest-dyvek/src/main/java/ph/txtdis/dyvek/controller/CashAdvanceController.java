...
public class CashAdvanceController
	...
	public ResponseEntity<?> check(@RequestParam("bank") String bank, @RequestParam("id") Long id) {
	...
	public ResponseEntity<?> customer(@RequestParam("type") PartnerType type, @RequestParam("name") String name) {
