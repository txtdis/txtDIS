...
public abstract class AbstractTruckService extends AbstractCreateNameListService<TruckRepository, TruckEntity, Truck>
		implements PrimaryTruckService {

	@Override
	protected Truck toDTO(TruckEntity e) {
	...
	@Override
	protected TruckEntity toEntity(Truck t) {
