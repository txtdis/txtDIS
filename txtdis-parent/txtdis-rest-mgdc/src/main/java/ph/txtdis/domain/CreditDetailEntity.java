...
public class CreditDetailEntity extends AbstractDecisionNeededEntity<Long> implements CustomerCredit {
	...
	public String toString() {
		return "term=" + termInDays + ", gracePeriod=" + gracePeriodInDays + ", creditLimit=" + creditLimit
				+ ", startDate=" + startDate;
	}
}
